...
public class RequestController {
    ...
    public String saveRequest(@Valid SupportRequest request, BindingResult bindingResult, Model model, RedirectAttributes redirectAttributes){
    ...
    public String editSaveRequest(SupportRequest request, RedirectAttributes redirectAttributes){
        ...
        return "redirect:/editRequest/" + request.getId();
    }
